...
## Project Structure
    ...
    ├── komatsu_kpi_dashboa_37606  # Django project configurations
...
1. Clone this repo and `cd komatsu_kpi_dashboa_37606`
...
2. Clone this repo and `cd komatsu_kpi_dashboa_37606`
